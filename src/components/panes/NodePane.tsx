  ...
  return (
    <div style={{
      ...
      <PaneHeader slot={slot} onCollapse={onCollapse} onSwapPanes={onSwapPanes}>
        ...
        {openTabs.length === 0 ? (
          <span style={{ fontSize: '12px', color: 'var(--accent-dark)' }}>No tabs open</span>
        ) : (
          openTabs.map((tabId) => {
            ...
            return (
              <div
                ...
                onDragStart={(e) => {
                  ...
                  e.dataTransfer.setData('application/x-ls-tab', JSON.stringify({ id: tabId, title, sourceSlot: slot }));
                ...
                style={{
                  ...
                  gap: '4px',
                  padding: '4px 8px',
                  background: isActiveTab ? 'var(--bg-elevated)' : 'transparent',
                  borderRadius: '4px',
              ...
              >
                <button
                  ...
                  style={{
                    fontSize: '11px',
                    color: isActiveTab ? 'var(--text-primary)' : 'var(--accent-primary)',
                    background: 'transparent',
                    border: 'none',
                    cursor: 'pointer',
                    padding: 0,
