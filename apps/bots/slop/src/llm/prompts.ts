export function buildSystemPrompt(options: {
  ...
  const rules = [
    ...
    "- slop_get_recent_papers: default for recent papers, papers people mentioned, papers people are talking about, and the Paper Club paper queue.",
    "- slop_get_recent_paper_candidates: legacy fallback for old Paper Club candidate event nodes only.",
